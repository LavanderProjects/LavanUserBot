...
#
from LavanUserBot.userbot import LAVAN_VERSION
from userbot import CMD_HELP, ASYNC_POOL, tgbot, SPOTIFY_DC, G_DRIVE_CLIENT_ID, lastfm, YOUTUBE_API_KEY, OPEN_WEATHER_MAP_APPID, AUTO_PP, REM_BG_API_KEY, OCR_SPACE_API_KEY, PM_AUTO_BAN, ASISTAN, MYID, BOTLOG_CHATID, LAVAN_VERSION, SUDO_ID
...
**Lavan {LANG['VERSION']}:** `{LAVAN_VERSION}`
