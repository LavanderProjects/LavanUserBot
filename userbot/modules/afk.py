...
async def set_afk(afk_e):
    ...
    if string:
        ...
        \n{LANG['REASON']}: `{string}`")
        await afk_e.client(UpdateProfileRequest(about='Sahibim Şuan #AFK @Lavanuserbot ✨')) #BUNU KULLANIPTA CR VERMEYENİN ANASINI SİKİM TEŞEKKÜRLER / ByMisakiMey
    else:
        await afk_e.edit(LANG['IM_AFK'])
        await afk_e.client(UpdateProfileRequest(about='Sahibim Şuan #AFK @Lavanuserbot ✨'))
    SON_GORULME = time()
    if BOTLOG:
